...
if __name__ == "__main__":
    ...
    # with open("final_cheatsheet.json", "w", encoding="utf-8") as f:
    #     json.dump(global_cheatsheet.data, f, indent=4)

    with open("/data/wentao/GEAK-agent/outputs/test/optimagent_gpt41_mini_init_reflect_dc_cheatsheet_1.json", "r", encoding="utf-8") as f:
        data = json.load(f)
