# tilelang.jit.adapter.cutedsl.wrapperÂ¶
...
`TLCuTeDSLSourceWrapper` | Wrapper class for TileLang CuTe DSL backend with C++ launcher.  
---|---  
  
## Module ContentsÂ¶

tilelang.jit.adapter.cutedsl.wrapper.CPP_TMA_DESC_INIT_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_TMA_IM2COL_DESC_INIT_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_TMA_INIT_FUNC_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_KERNEL_INIT_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_TMA_LAUNCH_INIT_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_KERNEL_LAUNCH_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_COOPERATIVE_KERNEL_LAUNCH_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CPP_LAUNCHER_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CUBIN_TMA_ATOM_INIT_TEMPLATE _ = ' {desc_name} = tl.Gemm_SM90.get_tma_atom(__fake_tensor__, (32, 32))'_Â¶
    

tilelang.jit.adapter.cutedsl.wrapper.CUBIN_KERNEL_LAUNCH_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.CUBIN_FAKE_TENSOR_TEMPLATE _ = ' __fake_{arg_name}__ = make_fake_compact_tensor(_DTYPE_MAP[str({arg_name}.dtype)],..._Â¶
    

tilelang.jit.adapter.cutedsl.wrapper.CUBIN_GEN_CODE_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
tilelang.jit.adapter.cutedsl.wrapper.PYTHON_HOST_FUNC_TEMPLATE _ = Multiline-String_Â¶
    Show Value
...
_class _tilelang.jit.adapter.cutedsl.wrapper.TLCuTeDSLSourceWrapper(_scheduled_ir_module_ , _source_ , _target_ , _device_mod =None_, _host_mod =None_, _pass_configs =None_)Â¶
    

Bases: [`tilelang.jit.adapter.wrapper.TLCUDASourceWrapper`](../../wrapper/index.html#tilelang.jit.adapter.wrapper.TLCUDASourceWrapper "tilelang.jit.adapter.wrapper.TLCUDASourceWrapper")
...
Override parentâs host_func to return generated Python code.

generate_tma_descriptor_args(_desc_name_map_ , _desc_name_var_map_ , _tma_desc_code_map_)Â¶
...
Parameters:
  ...
  * **tma_desc_code_map** (_dict_ _[__str_ _,__str_ _]_)
...
create_dispatch_func_cpp_launcher(_code_ , _function_informations_)Â¶
    

Create dispatch function using C++ launcher.

get_launcher_cpp_code()Â¶
