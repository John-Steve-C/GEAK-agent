# Logging in Tilelang/TVMÂ¶

_Author:_ [SiriusNEO](https://github.com/SiriusNEO)

## TVM Logging OverviewÂ¶
...
The design style is inspired by [Googleâs glog](https://google.github.io/glog/stable/).
...
There are three primary macro types:
  ...
  * **VLOG** : [Verbose logging](https://google.github.io/glog/stable/logging/#verbose-logging), primarily for debugging. Its main feature is customizable verbosity levels. For example, VLOG(n) where n can be 1, 2, 3, 4, 5, or 6, enabling complex tracing requirements. In contrast, LOG and DLOG typically use predefined verbose levels like INFO and DEBUG.
    ...
    * TVMâs VLOG is implemented using DLOG, thus inheriting DLOGâs characteristics.
...
## Using Logging in TileLang DevelopmentÂ¶
...
### Enabling Log Output in TilelangÂ¶
...
#### Detailed Rules for TVM_LOG_DEBUG SpecificationÂ¶
...
Tilelangâs CMake logic automatically adds the `TVM_LOG_DEBUG` macro, compiling all DLOG statements:
