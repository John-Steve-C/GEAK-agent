# General Matrix-Vector Multiplication (GEMV)Â¶

===========================================

_Contributor:_ [@botbw](https://github.com/botbw)
...
## Naive Implementation in TileLangÂ¶
...
At this level, we only gain very little computation power from our GPU with around **~0.17 ms** compared to torch/cuBLASâs **~0.008 ms** , which is around 20x slower.
...
### Customizing Parallelism in K DimensionÂ¶
...
## `tvm_thread_allreduce` Instead of `atomicAdd`Â¶
...
### Benchmark Table on Hopper GPUÂ¶
