# Auto-Tuning Techniques for Performance OptimizationÂ¶

_Author:_ [yyttt6](https://github.com/yyttt6)
...
Auto-tuning a Tile Language program involves three main steps:
  ...
  2. âProvide candidate configurations through manual search or auto-generation using Carver
...
### Step 1: Implement with Reserved ParametersÂ¶
...
### Step 2: Generate Candidate ConfigurationsÂ¶
...
## Using Carver to Auto-Generate Candidate ConfigurationsÂ¶
