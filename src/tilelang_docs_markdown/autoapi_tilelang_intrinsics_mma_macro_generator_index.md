# tilelang.intrinsics.mma_macro_generatorÂ¶
...
---|---  
`TensorCoreIntrinEmitterWithLadderTransform` | To eliminate Python syntax within TIR Macro.  
`INT4TensorCoreIntrinEmitter` | To eliminate Python syntax within TIR Macro.  
`INT4TensorCoreIntrinEmitterWithLadderTransform` | To eliminate Python syntax within TIR Macro.  
  
## Module ContentsÂ¶

tilelang.intrinsics.mma_macro_generator.liftÂ¶
    

_class _tilelang.intrinsics.mma_macro_generator.TensorCoreIntrinEmitter(_a_dtype =T.float16_, _b_dtype =T.float16_, _accum_dtype =T.float16_, _a_transposed =False_, _b_transposed =False_, _block_row_warps =2_, _block_col_warps =2_, _warp_row_tiles =8_, _warp_col_tiles =8_, _chunk =16_, _reduce_k =1_, _num_elems_per_byte =1_, _is_m_first =False_, _thread_var =None_)Â¶
...
is_m_first _: [bool](../../language/dtypes/index.html#tilelang.language.dtypes.bool "tilelang.language.dtypes.bool")_ _ = False_Â¶
    

warp_rows _: int_ _ = 1_Â¶
    

warp_cols _: int_ _ = 1_Â¶
...
_class _tilelang.intrinsics.mma_macro_generator.TensorCoreIntrinEmitterWithLadderTransform(_a_dtype =T.float16_, _b_dtype =T.float16_, _accum_dtype =T.float16_, _a_transposed =False_, _b_transposed =False_, _block_row_warps =2_, _block_col_warps =2_, _warp_row_tiles =8_, _warp_col_tiles =8_, _chunk =16_, _reduce_k =1_, _num_elems_per_byte =1_, _is_m_first =False_, _transform_kind_a =0_, _transform_kind_b =0_)Â¶
...
Parameters:
  ...
  * **transform_kind_a** (_int_ _|__tilelang.common.TransformKind_)

  * **transform_kind_b** (_int_ _|__tilelang.common.TransformKind_)
...
mma(_A_local_buf_ , _B_local_buf_ , _C_local_buf_)Â¶
    

_class _tilelang.intrinsics.mma_macro_generator.INT4TensorCoreIntrinEmitter(_a_dtype =T.float16_, _b_dtype =T.float16_, _accum_dtype =T.float16_, _a_transposed =False_, _b_transposed =False_, _block_row_warps =2_, _block_col_warps =2_, _warp_row_tiles =8_, _warp_col_tiles =8_, _chunk =16_, _reduce_k =1_, _num_elems_per_byte =1_, _is_m_first =False_, _thread_var =None_)Â¶
...
_class _tilelang.intrinsics.mma_macro_generator.INT4TensorCoreIntrinEmitterWithLadderTransform(_a_dtype =T.float16_, _b_dtype =T.float16_, _accum_dtype =T.float16_, _a_transposed =False_, _b_transposed =False_, _block_row_warps =2_, _block_col_warps =2_, _warp_row_tiles =8_, _warp_col_tiles =8_, _chunk =16_, _reduce_k =1_, _num_elems_per_byte =1_, _is_m_first =False_, _transform_kind_a =0_, _transform_kind_b =0_)Â¶
