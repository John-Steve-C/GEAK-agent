# tilelang.jit.adapter.cython.kernel_cacheÂ¶

## ClassesÂ¶

`CythonKernelCache` | Caches compiled kernels using a class and database persistence to avoid redundant compilation.  
---|---  
  
## Module ContentsÂ¶

_class _tilelang.jit.adapter.cython.kernel_cache.CythonKernelCacheÂ¶
