...
class OptimAgent(Reflexion_Oneshot):
    ...
    def run(self, output_path=None, multi_thread=True, datalen=None, iteration_num=0, temperature=0, ancestor_num=2, start_idx=0, gpu_id=0, start_iter=0, update_cheatsheet=True):
        """
        Args:
            ...
            update_cheatsheet: whether record usage, curate, prune, and save the cheatsheet after each iteration
        """
        ...
        for iter in range(start_iter, start_iter + iteration_num):
            ...
            # update cheatsheet
            if update_cheatsheet and not BASELINE_CONTROLLER:
