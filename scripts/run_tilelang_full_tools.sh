...
export TILELANG_LLM_MODEL=/shared/models/hf/Qwen3.5-35B-A3B
...
export TILELANG_MAX_LLM_REQUESTS=32
export TILELANG_MAX_EVAL_WORKERS=4
export TILELANG_EVAL_GPU=2
...
"${TILELANG_PYTHON}" src/run_tilelang_eval.py
